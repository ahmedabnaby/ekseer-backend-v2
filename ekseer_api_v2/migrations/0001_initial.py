    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(help_text='Full name should contain only letters.', max_length=255, validators=[django.core.validators.RegexValidator(message='Full name must contain only Arabic or English letters.', regex='[a-zA-Z\u0600-ۿ]+')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_time', models.CharField(blank=True, max_length=255, null=True)),
                ('patient_time', models.CharField(blank=True, max_length=255, null=True)),
                ('awaiting_time', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('call_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ekseer_api_v2.call')),
            ],
        ),
        migrations.CreateModel(
            name='Consultation',
